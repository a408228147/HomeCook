...
/* 城市HTML模板 */
inCity._template = [
    '<h5 style="color:black"  style="font-family: 幼圆;color="#2b2b2b " >&nbsp;&nbsp;请选择城市</h5>',
    '<div class="screen">',
        '&nbsp;&nbsp;<a href="javascript:void(0)" class="shar" style="font-family: 幼圆; font-size="20px; text-decoration:none;  " >热门</a>&nbsp;&nbsp;',
        '&nbsp;&nbsp;<a href="javascript:void(0)" style="font-family: 微软雅黑; font-size="20px;" >ABCDEFG</a>&nbsp;&nbsp;',
        '&nbsp;&nbsp;<a href="javascript:void(0)" style="font-family: 微软雅黑; font-size="20px;" >HIJKL</a>&nbsp;&nbsp;',
        '&nbsp;&nbsp;<a href="javascript:void(0)" style="font-family: 微软雅黑; font-size="20px;" >MNOPQRST</a>&nbsp;&nbsp;',
        '&nbsp;&nbsp;<a href="javascript:void(0)" style="font-family: 微软雅黑; font-size="20px;" >WXYZ</a>',
    '</div>',
    '<div class="city_pos" style="font-family: 幼圆;  ">',
        '<div class="city_a_le1">',
        '</div>',
        '<div class="city_a_le1" style="display: none;color="#2b2b2b"">',
        '</div>',
        '<div class="city_a_le1" style="display: none; color="#2b2b2b" ">',
        '</div>',
        '<div class="city_a_le1" style="display: none";color="#2b2b2b" ">',
            ...
            for(var i=0,n=oCity[key][sortKey[j]].length;i<n;i++){
                ...
                if(key == 'hot'){
                   $(inCity.id).find(inCity.Children).eq(0).append('&nbsp;&nbsp;<a href="javascript:void(0)">' + oCity[key][sortKey[j]][i] + '</a>');
                    ...
                    str = '&nbsp;&nbsp;<a href="javascript:void(0)" style=" text-decoration:none; ">' + oCity[key][sortKey[j]][i] + '</a>';
